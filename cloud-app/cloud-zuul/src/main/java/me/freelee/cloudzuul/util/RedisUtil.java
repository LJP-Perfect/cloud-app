package me.freelee.cloudzuul.util;
...
public class RedisUtil {
    public static final String TOKEK_FIELD="token";
    ...
    public Boolean isBlackList(String token){
        return hasKey(RedisUtil.BLACKLIST_FIELD,token);
    ...
    public void addBlackList(String token){
        hset("blacklist", token,"true", JwtTokenUtil.EXPIRATION_REFRESH);
    }
